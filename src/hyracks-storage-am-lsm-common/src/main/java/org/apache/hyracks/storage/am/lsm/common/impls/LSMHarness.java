...
public class LSMHarness implements ILSMHarness {
    ...
    protected final boolean USE_LOCAL_UM;
//    private static final boolean useLocalUM = true;
    ...
    public LSMHarness(ILSMIndex lsmIndex, ILSMIOOperationScheduler ioScheduler, ILSMMergePolicy mergePolicy,
        ...
        this.USE_LOCAL_UM = lsmIndex.isLocalUM();
    }
    
//    public boolean useLocalUM() {
//    	return LSMHarness.useLocalUM;
//    }
    ...
    public UpdateMemo<Integer> getGlobalUM(){
    	return this.lsmIndex.getGlobalUM();
    }
}
