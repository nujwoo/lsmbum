...
public abstract class AbstractLSMIndex implements ILSMIndex {
    ...
    protected final boolean USE_LOCAL_UM = UpdateMemoConfig.USE_LOCAL_UM;
    protected final boolean CLEAN_UPON_FLUSHING = UpdateMemoConfig.CLEAN_UPON_FLUSHING;
    protected final boolean CLEAN_UPON_MERGING = UpdateMemoConfig.CLEAN_UPON_MERGING;
    
    protected UpdateMemo<Integer> globalUM;
    ...
    @Override
    public boolean isLocalUM() {
    	return this.USE_LOCAL_UM;
    }
